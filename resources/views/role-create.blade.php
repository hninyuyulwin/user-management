                        ...
                        <div class="card-body py-4">
                            ...
                            <form action="{{ route('role-store') }}" method="POST">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" value="{{ old('role') }}" name="role" class="form-control form-control-solid mb-3 mb-lg-0" />
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <div class="form-group">
                                        @foreach ($permissions as $permission)
                                            <input type="checkbox" id="forrole{{ $permission->id }}" name="permissions[]" class="" value="{{ $permission->id }}" />
                                            <label for="forrole{{ $permission->id }}">{{ $permission->name }}</label><br>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="text-center pt-15">
                                    ...
                                    <button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">Create Role</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    @else
                    <div class="alert alert-danger text-center">Don't permission to create Role.</div>
                    @endif
