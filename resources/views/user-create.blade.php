                        ...
                        <div class="card-body py-4">
                            ...
                            <form action="{{ route('user-store') }}" method="POST">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" value="{{ old('name') }}" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" />
                                    <span class="text-danger">@error('name'){{ '* '.$message }} @enderror</span>
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">Username</label>
                                    <span class="text-muted">Username must be unique</span>
                                    <input type="text" value="{{ old('username') }}" name="username" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Username" />
                                    <span class="text-danger">@error('username'){{ '* '.$message }} @enderror</span>

                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">Email</label>
                                    <input type="email" value="{{ old('email') }}" name="email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com"/>
                                    <span class="text-danger">@error('email'){{ '* '.$message }} @enderror</span>
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">Phone</label>
                                    <input type="number" value="{{ old('phone') }}" name="phone" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="09xxxxxxxxx"/>
                                ...
                                <div class="text-center pt-15">
                                    ...
                                    <button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">Register</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    @else
                    <div class="alert alert-danger text-center">Don't have permission to create user.</div>
                    @endif
