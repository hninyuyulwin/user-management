            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Permission Edit</li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Page title-->
                        ...
                        <div class="card-body py-4">
                            ...
                            <form action="{{ route('permission-update',$permission) }}" method="POST">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" value="{{ old('permission',$permission->name) }}" name="permission" class="form-control form-control-solid mb-3 mb-lg-0" />
                                ...
                                <div class="text-center pt-15">
                                    ...
                                    <button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">Edit</button>
                                </div>
                            </form>
                        </div>
                    </div>
